...
<div class="device-notification">
  <a class="device-notification--logo" href="/" style="margin-left: calc(50vw - 50px);margin-top: calc(50vh - 50px);">
    <p>Eliotctl.fr</p>
    <img src="assets/img/logo.webp" style="width: 68px; z-index: -1; position: relative; left: -87px;" alt="Welcome">
  </a>
      ...
      <div class="l-wrapper">
        <header class="header">
          <a class="header--logo" href="/">
            <p>Eliotctl.fr</p>
            <img src="assets/img/logo.webp" style="width: 69px;position: absolute;z-index: -1;left: 16px;" alt="Welcome">
          </a>
          ...
          <li class="l-section section" id="home">
            <div class="intro">
              <div class="intro--banner">
                <h1>Innovative<br>devops<br>work</h1>
              ...
              <div class="intro--options">
                <a href="#projects" onclick="scrollTozone('#projects')">
                  <h3>WebApps</h3>
                  <p>Front & Backend,<br> Creating custom solution</p>
                </a>
                <a href="#projects" onclick="scrollTozone('#projects')">
                  <h3>Micro services</h3>
                  <p>Creating containerisable solutions allowing scalability and continuous integration</p>
                </a>
                <a href="#projects"  onclick="scrollTozone('#projects')">
                  <h3>New technologies</h3>
                  <p>Chat bot, Data Science<br>Amplify your customer experience</p>
                </a>
              </div>
            </div>
          </li>
          <li class="l-section section" id="why">
            <div class="about">
              <div class="about--banner">
                <h2>New<br>Technologies<br>based on <br>your needs</h2>
                  ...
                  <li class="slider--item slider--item-center">
                    <a href="https://wellcheck.cloud">
                      <div class="slider--item-image">
                        <img src="assets/img/logo_v2.webp" alt="Wellcheck">
                      </div>
                      <p class="slider--item-title">Wellcheck</p>
                      <p class="slider--item-description">Wellcheck is a water quality analyser using 0G's IoT Network</p>
                    </a>
                  </li>
                  <li class="slider--item slider--item-right">
                    <a href="https://newtechstack.fr">
                        <div class="slider--item-image">
                          <img src="assets/img/nts_logo.webp" alt="Newtechstack logo">
                        </div>
                        <p class="slider--item-title">Newtechstack</p>
                        <p class="slider--item-description">We provide custom web solutions, support and IT professional training</p> 
                    </a>
		  </li>
                </ul>
